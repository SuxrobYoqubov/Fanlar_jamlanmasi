...
pdf_item = CallbackData("pdf", "item_id")
...
async def categories_keyboard():
    ...
    for category in categories:
        ...
        button_text = f"📚 {category['category_name']} ({number_of_items} ta ma'lumot)"
...
async def subcategories_keyboard(category):
    ...
    for subcategory in subcategories:
        ...
        button_text = f"📘 {subcategory['subcategory_name']} ({number_of_items} ta ma'lumot)"
...
def item_keyboard(category, subcategory, item_id):
    ...
    # markup.row(
    #     InlineKeyboardButton(
    #         text=f"PDF ko'rinishi", callback_data=pdf_item.new(item_id=item_id)
    #     )
    # )
    markup.row(
        InlineKeyboardButton(
